...
{
    public partial class PopupSondai : Form
    {
        public PopupSondai()
        {
            InitializeComponent();
        ...
        private void DrawChart(List<dynamic> data)
        {
            ...
            var chartArea = new ChartArea("Sơn đài");
            ...
            {
                series.Points.AddXY(item.Thời_gian, item.Sơn_đài);
            }
        ...
        private void PopupSondai_Load(object sender, EventArgs e)
        {
            LoadAndDisplayData();
        }
        ...
        private void LoadAndDisplayData()
        {
            ...
            try
            {
                ...
                if (dataGridView1.Columns.Contains("Sơn đài"))
                    dataGridView1.Columns["Sơn đài"].HeaderText = "Mực nước hồ (cm)";
